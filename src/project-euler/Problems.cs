...
namespace project_euler
{
    ...
    public partial class Problem
    {
        ...
        // 50-digit numbers. (see below)
        //--------------------------------------------------
        // The point of this is probably to create our own BigInteger class. But
        // I'm using the one in the .NET API
        //--------------------------------------------------
        [Theory]
        [InlineData(1, "37107287533902102798797998220837590246510135740250")]
        [InlineData(3, "157809211410916853570920356427320726420653771310417")]
        [InlineData(100, "5537376230390876637302048746832985971773659831892672")]
        public void P0013(int countNumbers, string expected)
        {
            ...
            var expected2 = BigInteger.Parse(expected);

            Assert.Equal(expected2, actual);

            IEnumerable<string> BigNumbers()
            {
                return new string[] {
